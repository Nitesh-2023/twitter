...
const uri = "mongodb+srv://twitter_admin:HGuXa2Gk7TePxCwo@cluster0.znrkcyq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    app.get('/userPost', async (req,res) => {
      const email = req.query.email;
      const pos = (await postCollection.find({email: email}).toArray()).reverse();
      res.send(pos);
    })
